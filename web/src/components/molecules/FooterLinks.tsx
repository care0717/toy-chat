...
import { Forum, PeopleAltRounded, ExitToApp, Launch} from '@material-ui/icons';
...
export const FooterLinks = () => {
    ...
    return (
        <BottomNavigation value={current} onChange={handleChange}>
            ...
            <BottomNavigationAction onClick={onClickLogout} label='Logout' value='logout' icon={<Launch />}/>
        </BottomNavigation>
    )
};